"""Runs — the most-touched resource. Mirrors BFF /v1/runs/*."""
...
class Runs:
    ...
    def list(
        ...
        *,
        ...
        # /v1/runs is on run_svc, but we hit BFF — there is no BFF wrapper for
    ...
    def cancel(self, run_id: str) -> dict[str, Any]:
        ...
        engine_svc workers see the Kafka event within ~1 round-trip."""
        return self._c.post(f"/v1/runs/{run_id}/cancel")

    def kick(self, run_id: str) -> dict[str, Any]:
        """Nudge engine_svc to pick up this run immediately (otherwise it
